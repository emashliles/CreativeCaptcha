...
namespace CreativeCaptcha.WebApi
{
    public class AddNewCaptchaModule : NancyModule
    {
        ...
        private AddBasicConfirmationResponse _Validate(AddBasicRequest request)
        {
            ...
            repo.AddBasicImage(request.ImagePath, request.StartPoint.XCoordinate, request.StartPoint.YCoordinate, request.StartPoint.Direction, request.ID, request.DescriptiveSentence, request.Movements);
